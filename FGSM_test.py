...
parser.add_argument('--remote_models',  default=['inception_v3', 'inception_v4', 'inception_resnet_v2', 
        'resnet101', 'xception', 'dpn98', 'vgg19','convnext_base','vit_base_patch16_224','efficientnetv2_rw_m',
        'mixer_b16_224','ens_adv_inception_resnet_v2','adv_inception_v3'], type=list, help='test model name')
